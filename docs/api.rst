...
---------------------------------------------------
*fMRIPost-rapidtide* is a *NiPreps* application, and abides by the
...
---------------------------------------
We believe that *fMRIPost-rapidtide* must be free to use, inspect, and critique.
...
.. automodule:: fmripost_rapidtide.config
   :members: from_dict, load, get, dumps, to_filename, init_spaces

Workflows
---------

.. automodule:: fmripost_rapidtide.workflows.base
.. automodule:: fmripost_rapidtide.workflows.rapidtide
