# fmripost_rapidtide documentation build configuration file, created by
...
project = 'fMRIPost-rapidtide'
author = 'The fMRIPost-rapidtide developers'
...
# html_title = u'fmripost_rapidtide vversion'
...
htmlhelp_basename = 'fmripost_rapidtide_doc'
...
latex_documents = [
    (master_doc, 'fmripost_rapidtide.tex', 'fMRIPost-rapidtide Documentation', author, 'manual'),
]
...
man_pages = [(master_doc, 'fmripost-rapidtide', 'fMRIPost-rapidtide Documentation', [author], 1)]
...
texinfo_documents = [
    (
        master_doc,
        'fMRIPost-rapidtide',
        'fMRIPost-rapidtide Documentation',
        author,
        'fMRIPost-rapidtide',
...
linkcode_resolve = make_linkcode_resolve(
    'fmripost_rapidtide',
    'https://github.com/nipreps/fMRIPost-rapidtide/blob/{revision}/{package}/{path}#L{lineno}',
)
