...
def _build_parser(**kwargs):
    ...
    g_rapidtide = parser.add_argument_group('Options for running ICA_Rapidtide')
    g_rapidtide.add_argument(
    ...
    g_rapidtide.add_argument(
        ...
        default=False,
        help=(
            'Raise an error if ICA_Rapidtide does not produce sensible output '
