...
class _ICARapidtideInputSpecRPT(BaseInterfaceInputSpec):
    in_file = File(
        exists=True,
        mandatory=True,
        desc='BOLD series input to Rapidtide',
    )
    ...
    rapidtide_noise_ics = File(
        exists=True,
        desc='Noise components estimated by Rapidtide, in a comma-separated values file.',
    )
    out_report = File(
        'rapidtide_reportlet.svg',
        usedefault=True,
...
class _ICARapidtideOutputSpecRPT(TraitedSpec):
    out_report = File(
        exists=True,
        desc='Filename for the visual report generated by Nipype.',
    )
...
class ICARapidtideRPT(SimpleInterface):
    """Create a reportlet for Rapidtide outputs."""

    input_spec = _ICARapidtideInputSpecRPT
    output_spec = _ICARapidtideOutputSpecRPT
    ...
    def _run_interface(self, runtime):
        ...
        plot_melodic_components(
            ...
            noise_components_file=self.inputs.rapidtide_noise_ics,
        )
        self._results['out_report'] = out_file
        return runtime


class _ICARapidtideMetricsInputSpecRPT(BaseInterfaceInputSpec):
    rapidtide_features = File(
        exists=True,
        mandatory=True,
        desc='Rapidtide metrics',
    )
    out_report = File(
...
class _ICARapidtideMetricsOutputSpecRPT(TraitedSpec):
    out_report = File(
        exists=True,
        desc='Filename for the visual report generated by Nipype.',
    )
...
class ICARapidtideMetricsRPT(SimpleInterface):
    """Create a reportlet for Rapidtide outputs."""

    input_spec = _ICARapidtideMetricsInputSpecRPT
    output_spec = _ICARapidtideMetricsOutputSpecRPT
    ...
    def _run_interface(self, runtime):
        ...
        df = pd.read_table(self.inputs.rapidtide_features)
