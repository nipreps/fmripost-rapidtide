...
from fmripost_rapidtide.tests.utils import (
    check_generated_files,
    download_test_data,
    get_test_data_path,
)
from fmripost_rapidtide.utils.bids import write_derivative_description


@pytest.mark.integration()
@pytest.mark.ds005115_deriv_only()
def test_ds005115_deriv_only(data_dir, output_dir, working_dir):
    """Run fMRIPost-rapidtide on ds005115 fMRIPrep derivatives with MNI152NLin6Asym-space data."""
...
def test_ds005115_resampling_and_raw(data_dir, output_dir, working_dir):
    """Run fMRIPost-rapidtide on ds005115 raw BIDS + resampling-level fMRIPrep derivatives."""
...
def _run_and_generate(test_name, parameters, test_main=True):
    ...
    if test_main:
        ...
        argv = ['fmripost_rapidtide'] + parameters
