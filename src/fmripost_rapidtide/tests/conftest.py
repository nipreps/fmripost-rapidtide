...
def data_dir():
    """Grab data directory."""
    test_data = importlib.resources.files('fmripost_rapidtide.tests') / 'data'
...
@pytest.fixture(scope='session')
def base_config():
    from fmripost_rapidtide.tests.tests import mock_config
...
def base_ignore_list():
    """Create the standard ignore list used by fMRIPost-rapidtide."""
    return [
        'code',
        'stimuli',
        'sourcedata',
